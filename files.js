...
function internalCard() {
  ...
  cursor.onsuccess = function () {
    if (this.result.name.lastIndexOf('.mp4') === this.result.name.length - 4 || this.result.name.lastIndexOf('.3gp') === this.result.name.length - 4) {
      ...
      item.addEventListener('focus', function () {
        document.querySelector('#fdet').innerHTML = '<table width="100%" style="color: black"><tr><td style="width: 50%;text-align: center">' + file.size + ' Bytes</td><td style="width: 50%;text-align: center">' + file.type + '</td></tr></table>';
...
function keydownvideolist(e) {
  switch (e.key) {
    ...
    case 'Enter': document.activeElement.click();
      break;
    case 'SoftRight': localStorage.removeItem('opened_page'); window.location.href = 'index.html';
      break;
    case 'F2': localStorage.removeItem('opened_page'); window.location.href = 'index.html';
      break;
